...
namespace SIAPG
{
    public partial class FormImportarIngreso : Form
    {
        ...
        public FormImportarIngreso()
        {
            InitializeComponent();
        }

        private void FormImportarIngreso_Load(object sender, EventArgs e)
        {
        ...
        private void buttonImportar_Click(object sender, EventArgs e)
        {
            ...
            {
                _ClassParametros.RutaArchivoIngreso = textBoxRuta.Text.ToString();
                _ClassParametros.NombreHojaIngreso = comboBoxHoja.Text;
